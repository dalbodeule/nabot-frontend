  ...
  <div>
    <section class="section">
      ...
      <div class="content box">
        ...
        <h3>1. 명령어 기능</h3>
        <p>
          치봇은 다양한 커스텀 명령어를 제공하여 스트리머와 치수가 손쉽게 소통할 수 있도록
          합니다. 관리자는 다양한 명령어를 추가, 수정, 삭제할 수 있으며, 이를 통해
          사용자와의 상호작용을 더욱 풍부하게 할 수 있습니다.
        </p>

        <h3>2. 신청곡 기능</h3>
        <p>
          사용자는 치봇을 통해 신청곡을 추가하고 재생할 수 있습니다. 이 기능은 실시간
          스트리밍을 지원하며, 원하는 곡을 쉽게 추가할 수 있어 치수들의 요청을 실시간으로
          반영할 수 있습니다.
        </p>

        <h3>3. 타이머 기능</h3>
        <p>
          치봇은 타이머 기능을 제공합니다. 사용자는 타이머를 설정하여 특정 시간에 알림을
          받거나, 업타임을 위젯으로 쉽게 알 수 있습니다. 이 기능은 이벤트 관리나 시간
          제한이 필요한 작업에 유용합니다.
        </p>
